...
function ControlsAndInput(){
    ...
    var rateSliderX =  width - 140; // also assigned in draw()
    var rateSliderY =  30;
    
    var panSliderX =  width - 140; // also assigned in draw()
    var panSliderY =  75;
    ...
    // menu border
    var menuWidth = width; // also assigned in draw()
    var menuHeight = height/6;
